...
**Last updated:** 2026-09-18 (RPC streaming landed, and real remote graphics access via SSH port-forward — validated against a real domain's real VNC server, see "Completed" below; plan stories 1–11 done and validated against real infra — see `docs/plan.md`)
